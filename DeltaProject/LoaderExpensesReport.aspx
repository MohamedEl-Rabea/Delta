<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="LoaderExpensesReport.aspx.cs" Inherits="DeltaProject.LoaderExpensesReport" %>
        ...
        <div id="divToPrint" class="Prices_Offer_DivBill">
            ...
            <section class="ReportDeclarationSection">
                <section>
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="Label3" runat="server" Text="الونش : " CssClass="lblInfo"></asp:Label>
                            </td>
                            <td style="width: 125px">
                ...
                <section>
                    ...
                    <asp:GridView runat="server" ID="GridViewLoaderProcesses" CssClass="GridViewBill"
                        AutoGenerateColumns="False" EmptyDataText="لا توجد عمليات" ShowFooter="true">
                        <Columns>
                            <asp:BoundField DataField="Date" HeaderText="تاريخ العملية" SortExpression="Date" DataFormatString="{0:dd/MM/yyyy}" />
