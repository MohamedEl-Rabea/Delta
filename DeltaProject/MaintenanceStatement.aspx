<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="MaintenanceStatement.aspx.cs" Inherits="DeltaProject.MaintenanceStatement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content_Section" runat="server">
    ...
    <asp:Panel ID="PanelErrorMessage" runat="server" CssClass="ErrorMessagePanal" Visible="false">
        <article class="Errorarticle">
            <asp:Label ID="LabelErrMsg" runat="server" CssClass="LblErrorMsg2" Text="لا توجد حسابات صيانات مسجله لهذا العميل"></asp:Label>
        </article>
    </asp:Panel>
