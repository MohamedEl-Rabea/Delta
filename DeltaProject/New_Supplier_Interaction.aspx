<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="New_Supplier_Interaction.aspx.cs" Inherits="DeltaProject.New_Supplier_Interaction" %>
    ...
    <asp:Panel ID="PanelPaymentInfo" runat="server">
                    ...
                    <tr>
                        ...
                        <td style="text-align: right">
                            <asp:RadioButtonList ID="rblPaymentType" ClientIDMode="Static" runat="server" CssClass="ChoiceRadioList" RepeatDirection="Horizontal">
                                <asp:ListItem Text="دفع" Value="ToSupplier" />
                                <asp:ListItem Text="استحقاق" Value="FromSupplier" />
                            </asp:RadioButtonList>
                        </td>
                    </tr>
                    <tr>
        ...
        <div>
            ...
            <footer class="alarm_Footer">
                <p>- اذا كان نوع العمليه دفع فهو يوضح ان القيمة مدفوعه من الشركه للمورد</p>
                <p>- اذا كان نوع العمليه استحقاق فهو يوضح ان القيمة مدفوعه من المورد للشركه</p>
            </footer>
        </div>
    </asp:Panel>
    <asp:Panel ID="PanelAdd_Images" runat="server" Visible="false">
        <header class="Header">
            <div>
                <p>اضافة الصور</p>
            </div>
        ...
        <section class="Sec_table">
            <table>
                <tr>
                    <td class="RHSTD">
                        <p class="RHSP">اختر الصوره :</p>
                    </td>
                    <td>
                        <asp:FileUpload ID="FileUploadImages" Width="200" runat="server" />
                    </td>
                </tr>
            </table>
        </section>
        ...
        <br />
        <footer class="AddSupplierFooter">
            <asp:Button ID="ButtonAdd_Image" runat="server" Text="اضافه" CssClass="BtnNext" OnClick="ButtonAdd_Image_Click" />
            <div style="text-align: center">
                <asp:Label ID="lblErrMsgImages" runat="server" Visible="false" CssClass="MessageLabel"></asp:Label>
            </div>
        </footer>
    </asp:Panel>
</asp:Content>
