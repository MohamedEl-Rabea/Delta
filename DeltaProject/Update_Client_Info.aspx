<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Update_Client_Info.aspx.cs" Inherits="DeltaProject.Update_Client_Info" %>
        ...
        <section class="PreReport_Section">
            <table class="AddProductsTable">
                ...
                <tr>
                    ...
                    <td style="text-align: right">
                        <asp:TextBox runat="server" ID="txtAddress" CssClass="txts2" PlaceHolder="عنوان العميل" AutoCompleteType="Disabled"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <asp:ImageButton ID="ImageButtonDelete" runat="server" ImageUrl="~/Images/Delete.png" Width="16" Height="16"
                                            ...
                                            OnClientClick="return confirm('سيتم مسح هذا الرقم من بيانات العميل . . . هل تريد المتابعه ؟');" />
                                    </ItemTemplate>
                                    <EditItemTemplate>
