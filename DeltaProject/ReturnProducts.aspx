...
<asp:Content ID="Content2" ContentPlaceHolderID="Content_Section" runat="server">
    ...
    <asp:Panel runat="server" ID="PanelBills" Visible="false">
        <asp:GridView ID="GridViewBills" runat="server" AutoGenerateColumns="False" OnRowCommand="GridViewPaidBills_RowCommand"
    ...
    <asp:Panel runat="server" ID="PanelBillDetails" Visible="false">
        ...
        <section class="ContactsSection" style="border: 0; width: 99%; text-align: right; direction: rtl; padding: 10px;">
            ...
            <asp:GridView runat="server" ID="GridViewBillList" CssClass="GridViewBill" AutoGenerateColumns="False" EmptyDataText="لا توجد منتجات"
                          OnRowDataBound="GridViewBillList_OnRowDataBound">
                <Columns>
