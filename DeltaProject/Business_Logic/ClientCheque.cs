...
namespace Business_Logic
{
    public class ClientCheque
    {
        ...
        public static int Get_ClientCheques_Count_By_C_Name(string Client_Name)
        {
            int Count;
            string CS = ConfigurationManager.ConnectionStrings["DBCS"].ConnectionString;
            SqlConnection con = new SqlConnection(CS);
            SqlCommand cmd = new SqlCommand("Get_ClientCheques_Count_By_C_Name", con);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public bool Update_UnPaidClientCheques_By_Id(out string msg)
        {
            msg = "";
            bool isUpdated = true;
            string CS = ConfigurationManager.ConnectionStrings["DBCS"].ConnectionString;
        ...
        public bool Delete(out string msg)
        {
            ...
            try
            {
                SqlCommand cmd = new SqlCommand("Delete_ClientCheque_By_Id", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("@Id", SqlDbType.Int).Value = Id;
                con.Open();
                cmd.ExecuteNonQuery();
        ...
        public static List<ClientCheque> Get_All_ClientCheques(int Start_Index, int Max_Rows, string Client_Name)
        {
            List<ClientCheque> ClientCheques = new List<ClientCheque>();
            string CS = ConfigurationManager.ConnectionStrings["DBCS"].ConnectionString;
            SqlConnection con = new SqlConnection(CS);
            SqlCommand cmd = new SqlCommand("Get_All_ClientCheques", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add("@Client_Name", SqlDbType.NVarChar).Value = Client_Name;
